...
for (let item = 0; item < inventory.length; item++){
    if (inventory[item].id === 33){
        car33.push(inventory[item].car_year);
        car33.push(inventory[item].car_make);
        car33.push(inventory[item].car_model);
    }
}
console.log("Car 33 is a " + car33.join(" "));
...
let oldCars = [];
for (let item = 0; item < inventory.length; item++){
    if (inventory[item].car_year < 2000){
...
let BMWAndAudi = [];
for (let item = 0; item < inventory.length; item++){
    if(inventory[item].car_make === "BMW" || inventory[item].car_make === "Audi"){
        BMWAndAudi.push(inventory[item])
    }
}
